                            ...
                            <div class="inline-block min-w-full align-middle">
                                <div class="overflow-hidden ">
                                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                                        ...
                                        <tr  v-for="groups in items" :key="groups.id" class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <td class="p-4 w-4">
                                                <div class="flex items-center">
                                            ...
                                            <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">{{groups.name}}</td>
                                            <td class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap">
                                                <Link :href="route('groups.edit',{'id':groups.id})" class="text-blue-600 dark:text-blue-500 hover:underline">Edit</Link>
                                                <button @click="itemDelete(groups.id)" class="text-red-600 dark:text-blue-500 ml-4 hover:underline">Delete</button>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
